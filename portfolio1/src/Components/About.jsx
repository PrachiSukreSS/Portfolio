      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="mb-6">
              <img
                src="/photo.webp"
                alt="Your Name"
                className="w-32 h-32 rounded-2xl object-cover border-4 border-cyan-400/30 shadow-lg"
              />
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-6">My Journey</h3>
              <p className="text-gray-300 leading-relaxed mb-6">
                I'm a Computer Engineering student at JSPM's Rajarshi Shahu
                College of Engineering, Pune, with a strong passion for web
                development and automation. With a CGPA of 9.27, I'm actively
                involved in college-level coding initiatives.
              </p>
              <p className="text-gray-300 leading-relaxed mb-6">
                I'm always curious to explore new ideas and build things that
                solve real problems. My experience spans from frontend
                development with React.js to full-stack applications using the
                MERN stack.
              </p>
        ...
        <div className="space-y-6">
          ...
          <GlassmorphismCard className="p-6">
            ...
            <p className="text-gray-300">IIT Bombay Techfest Certificate</p>
            <p className="text-gray-300">
